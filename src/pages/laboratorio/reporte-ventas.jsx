...
const ReporteVentas = () => {
	...
	const [productosVendidos] = useState([
			...
			<div className="reporte-ventas-wrapper">
				...
				<div className="reporte-ventas-content">
					...
					<div className="controles-reporte-fila2">
						...
						<button
							className="btn-generar-graficas"
							onClick={() => alert("Generando gráficas...")}>
							Generar graficas
						</button>
					</div>
					...
					<div className="botones-reportes">
						<button
							className="btn-reporte verde"
							onClick={() => alert("Generando Reporte General...")}>
							Reporte General
						</button>
						<button
							className="btn-reporte verde"
							onClick={() => alert("Generando Reporte por Estudio...")}>
							Reporte por Estudio
						</button>
						<button
							className="btn-reporte verde"
							onClick={() => alert("Generando Reporte por Sumatoria...")}>
					...
					<div className="area-graficas">
						<div className="grafico-ventas-header">
							<img src={metricasIcono} alt="Gráfica" className="icono-grafica" />
							<span>Grafico de Ventas</span>
						</div>
						<div className="grafico-ventas-contenido"></div>
					</div>
					...
					<div className="secciones-inferiores">
						...
						<div className="ventas-vendedores-section">
							...
							<div className="lista-vendedores"></div>
						</div>
					</div>
				</div>
			</div>
